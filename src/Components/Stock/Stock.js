    ...
    return (
      <div className="Stock">
        <div className="Stock-information">
          <input key={this.props.stock.key}  type= 'text' value = {this.state.name} className="stockName" onChange = {this.handleNameChange}></input>
          <input key={this.props.stock.key} type='number' value = {this.state.alloc} className="allocation" onChange = {this.handleAllocChange}></input>
        </div>
        {this.renderAction()}
      </div>
    );
